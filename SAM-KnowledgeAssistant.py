...
API_TOKEN = "hgZhueHVdL0K5b4CXbTQDQtt2x47myOg" # Replace with your actual token or use st.secrets

# --- Example Prompts Data Structure ---
EXAMPLE_PROMPTS = {
    "Leads": [
        "Which active leads in Brazil are older than 90 days?",
        "How many total leads did we get from the 'Future of Imaging' campaign?"
    ],
    "Technical": [
        "What is the latest installed software version for SOMATOM Force scanners at Universitätsklinikum Ulm?"
    ],
    "Customer": [
        "What products does Universitätsklinikum Ulm A.d.ö.R. use?",
        "Are there any open CIARTIC Move Opportunities for Dallas VAMC?",
        "What is the status of quotes for Mayo Clinic?",
        "Which customers are using the CIARTIC Move product?"
    ],
    "Documents": [
        "Please find all documents for CIARTIC Move.",
        "What are the main features of CIARTIC Move?"
    ]
}
